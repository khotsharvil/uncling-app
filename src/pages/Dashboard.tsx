...
const Dashboard = () => {
  ...
  const getStyleMessage = (style) => {
    ...
    return messages[style] || messages.secure;
  };
      ...
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <Link to="/check-in" className="block pointer-events-auto relative z-10">
              <Card 
            ...
            <Link to="/rescue-me" className="block pointer-events-auto relative z-10">
              <Card 
                className="p-6 card-hover cursor-pointer bg-white/80 backdrop-blur-sm border-0 shadow-md"
              >
                <div className="text-center space-y-3">
            ...
            <Link to="/secure-chat" className="block pointer-events-auto relative z-10">
              <Card 
                className="p-6 card-hover cursor-pointer bg-white/80 backdrop-blur-sm border-0 shadow-md"
              >
              <div className="text-center space-y-3">
            ...
            <Link to="/before-you-rest" className="block pointer-events-auto relative z-10">
              <Card 
                className="p-6 card-hover cursor-pointer bg-white/80 backdrop-blur-sm border-0 shadow-md"
              >
                <div className="text-center space-y-3">
          ...
          <Link to="/progress" className="block pointer-events-auto relative z-10">
            <Card 
              className="p-6 card-hover cursor-pointer bg-white/80 backdrop-blur-sm border-0 shadow-md"
            >
              <div className="text-center space-y-3">
